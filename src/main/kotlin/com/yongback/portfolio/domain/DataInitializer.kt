...
class DataInitializer(
    ...
    fun initializeData() {
        ...
        val introductions = mutableListOf<Introduction>(
            ...
            Introduction(
                content = "기술을 위한 기술이 아닌, " +
                        "비즈니스 문제를 풀기 위한 기술을 추구합니다.",
                isActive = true
            ),
            Introduction(
                content = "기존 소스를 리팩토링하여 " +
                        "더 좋은 구조로 개선하는 작업을 좋아합니다.",
                isActive = true
            )
        )
        ...
        experienceRepository.saveAll(
            mutableListOf(experience1, experience2)
        )
        ...
        val project1 = Project(
            ...
            description = "유기묘 위치의 실시간 공유, 임시보호까지 연결해주는 서비스. " +
                    "구글 맵스를 연동하여 유기묘 위치 정보를 " +
                    "직관적으로 파악할 수 있도록 하는 사용자 경험 개선 작업.",
            startYear = 2022,
            startMonth = 9,
            endYear = 2022,
            endMonth = 12,
        ...
        val project2 = Project(
            ...
            description = "카메라에서 서버로 전달되는 신호를 분석하여 " +
                    "움직임이 감지될 경우 클라이언트에게 알림 발송 작업.",
            startYear = 2022,
            startMonth = 12,
            endYear = null,
            endMonth = null,
